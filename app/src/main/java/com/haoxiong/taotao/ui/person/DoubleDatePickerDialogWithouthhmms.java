 ...
 * </p>
 */
public class DoubleDatePickerDialogWithouthhmms extends AlertDialog implements OnClickListener, OnDateChangedListener {
	 ...
	 */
	public DoubleDatePickerDialogWithouthhmms(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
		this(context, 0, callBack, year, monthOfYear, dayOfMonth);
	}

	public DoubleDatePickerDialogWithouthhmms(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
			int dayOfMonth) {
	...
	public DoubleDatePickerDialogWithouthhmms(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
		...
		setView(view);
		mDatePicker_start = (DatePicker) view.findViewById(R.id.datePickerStart2);
